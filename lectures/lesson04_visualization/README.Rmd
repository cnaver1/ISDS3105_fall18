...
ggplot() +
geom_line(data =  twitter_users, aes(x = Year, y = millions), color ='green') 
```
...
ggplot() +  geom_line(data =  twitter_users, aes(x = Year, y = millions, color = 'twitter')) + geom_line(data =  sn_users, aes(x = year, y = facebook, color = 'facebook'))
```
...
```{r}
beerDt$birthyear <- beerDt$Year == myBirthYear
ggplot(data = beerDt,aes(x = Year, y = GallonsCapita))+
  geom_line(color= 'red') + geom_point(aes(color = birthyear))
